 ...
 *       &lt;sequence>
 *         &lt;element name="previous_ref" type="{}ref_dtls_t" minOccurs="0"/>
...
@XmlRootElement(name = "LIST_OF_SECURITY")
public class LISTOFSECURITY
    extends AnswerDocT
{

    @XmlElement(name = "previous_ref")
    ...
    protected List<LISTOFSECURITY.ListOfSecurity> listOfSecurity;
     ...
     * {@link LISTOFSECURITY.ListOfSecurity }
     * 
     * 
     */
    public List<LISTOFSECURITY.ListOfSecurity> getListOfSecurity() {
        if (listOfSecurity == null) {
            listOfSecurity = new ArrayList<LISTOFSECURITY.ListOfSecurity>();
        }
